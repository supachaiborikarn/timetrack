...
- Employee self-service instead shows a daily collection goal of **5 VALID `employee-v3` evaluations per Bangkok calendar day**, resetting at 00:00 Asia/Bangkok. This daily count is independent from the attendance calendar month being viewed and does not change the 64-point score formula.
