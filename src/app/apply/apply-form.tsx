...
export function ApplyForm({ stations, companyName, formToken }: ApplyFormProps) {
    const { t } = useLanguage();
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Field label={t("apply.station")} required>
                                        <Select value={form.stationId} onValueChange={(v) => setForm((p) => ({ ...p, stationId: v, departmentId: "" }))}>
                                            <SelectTrigger className="w-full"><SelectValue placeholder={t("apply.selectPlaceholder")} /></SelectTrigger>
                                            <SelectContent>
