...
export async function GET(request: NextRequest) {
    try {
        ...
        const dailyBreakdown = calculation.dailyRecords.map((record) => ({
            ...
            actualHours: record.attendance?.actualHours == null ? null : record.actualHours,
            ...
            breakPenalty: 0,
            totalPenalty: roundMoney(record.latePenalty + record.earlyLeavePenalty + record.otherDeduction),
        ...
        return successResponse({
            ...
            monthSummary: {
                ...
                totalPenalty: roundMoney(calculation.latePenalty + calculation.earlyLeavePenalty + calculation.otherExpenses + calculation.socialSecurity),
