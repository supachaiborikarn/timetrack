                ...
                <div className="tt-paper-card tt-instrument-frame rounded-[24px] border border-zinc-700/35 dark:border-white/15 p-6 sm:p-7 shadow-[0_3px_0_rgba(0,0,0,0.06)] text-zinc-950 dark:text-white">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-800 dark:text-[#fbbf24]">WORKFORCE REGISTRY & ROLES</p>
                                <h1 className="text-xl sm:text-2xl font-black text-zinc-950 dark:text-white">จัดการข้อมูลพนักงาน</h1>
                                <p className="text-zinc-600 dark:text-zinc-400 text-xs mt-0.5">ทะเบียนประวัติ, บทบาทสิทธิ์, การสังกัดสถานี และเอกสารพนักงาน ({employees.length} คน)</p>
                            </div>
                        </div>
