...
import { RestroomScoresTab } from "@/components/customer-feedback/admin/restroom-scores-tab";
...
const TAB_DEFINITIONS: { id: FeedbackTab; label: string; permission: string; probe: string }[] = [
    ...
    { id: "restroom-scores", label: "ห้องน้ำ / แม่บ้าน", permission: "customer_feedback.view_dashboard", probe: "/api/admin/customer-feedback/restroom-scores" },
    ...
    return (
        <div className="space-y-6 font-sans">
            ...
            <div className="tt-paper-card tt-instrument-frame rounded-[24px] border border-zinc-700/35 dark:border-white/15 p-6 sm:p-7 shadow-[0_3px_0_rgba(0,0,0,0.06)] text-zinc-950 dark:text-white">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-800 dark:text-[#fbbf24]">SERVICE EXCELLENCE & VOC</p>
                            <h1 className="text-xl sm:text-2xl font-black text-zinc-950 dark:text-white">เสียงลูกค้า & คุณภาพบริการ</h1>
            ...
            <Tabs value={activeTab} onValueChange={changeTab} className="space-y-4">
                ...
                {permissions.has("customer_feedback.view_dashboard") && <TabsContent value="restroom-scores"><RestroomScoresTab /></TabsContent>}
