...
- มีสูตรแต๊ะเอียตรุษจีนแบบคาดการณ์ 100 คะแนนแล้ว: พนักงานหน้าลานใช้ 25/30/15/20/10 และเสมียนปั๊มน้ำมันใช้ 25/20/15/30/10 (ทีม 35% + ตัวเอง 65%); ยังเป็น preview เท่านั้นและระบบยังไม่ส่งคะแนนหรือยอดโบนัสเข้า Payroll อัตโนมัติ
...
8. ก่อนผูกแต๊ะเอียกับ Payroll จริง ต้องอนุมัติยอดแต๊ะเอียฐาน วิธี freeze ผลรอบ การทบทวนเคสความปลอดภัย และช่องทางอุทธรณ์/แก้ข้อมูล; ปัจจุบันมีเฉพาะ forecast UI และการให้คะแนนหัวหน้างาน
