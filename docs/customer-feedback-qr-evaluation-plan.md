...
ปัจจุบันระบบมีเกณฑ์แต๊ะเอียตรุษจีนแบบ **คาดการณ์เท่านั้น** ใน repository แล้ว โดยมีโปรไฟล์พนักงานหน้าลานและเสมียนปั๊มน้ำมัน (เสมียน: ผลทีม 35% + ผลงานตัวเอง 65%) แต่ยังแยกจาก Payroll และไม่เขียนยอดโบนัสอัตโนมัติ; ดูกติกาปัจจุบันใน `secondbrain/notes/Decisions.md`
